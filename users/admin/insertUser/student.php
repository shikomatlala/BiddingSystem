...
class Student
{
  ...
  {
    $sql = "SELECT MAX(staff_number) AS max_value \n"
        . "FROM lecturer";
  ...
  {
     $out= 1;
     $sql = "SELECT * FROM lecturer WHERE id_nr  = \"$id_nr\" ";
  ...
  public function validate_phone($phone,$link)
  {
    //"0723302232"
     $out= 0;
     $sql = "SELECT * FROM lecturer WHERE phone= \"$phone\" ";
     $result = mysqli_query($link, $sql);
  ...
  public function get_student_label()
  {
      $label = new Label();
      $label_increment = "";
      $label->set_label("","Staff Number: ". $this->stud_number, "");
      $label_increment .= "\n". $label->get_label() . "<br>";
  ...
  public function view_sql()
  {
    ...
    $sql = "INSERT INTO lecturer  (`staff_number`, `first_name`, `last_name`, `id_nr`, `sex`, `phone`, `email`, `address`) VALUES\n"
