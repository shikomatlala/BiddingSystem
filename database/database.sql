...
INSERT INTO `auctionStatus` (`status`) VALUES ('Incomplete');
...
INSERT INTO `auctionStatus` (`status`) VALUES ('Withdrawn');
...
(
    ...
    FOREIGN KEY (`statusId`) REFERENCES `auctionStatus` (`statusId`)
);
