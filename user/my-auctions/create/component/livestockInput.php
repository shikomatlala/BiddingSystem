        ...
        <form action="component/createAuction.php" method="POST" >
            <div id="createAuctionDiv" class="">
                ...
                <div id="animalNameDiv" class="">
                    ...
                    <input class="" type="text" id="inputAnimalName" name="inputAnimalName" placeholder="Livestock Name" >
                </div>
                ...
                <div id="startDateDiv" class="">
                    ...
                    <input class="" type="datetime-local" id="startDate" name="startDate"  required>

                </div>

                <div id="endDateDiv" class="">
                    <lablel for="endDate" class="" name="lblEndDate" id="lblEndDate">Choose End Date</label><br> 
                    <input class="" type="datetime-local" id="endDate" name="endDate" required>
